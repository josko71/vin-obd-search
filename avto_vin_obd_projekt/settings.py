...
"""
Django settings for avto_vin_obd_projekt project.
...
# ALLOWED_HOSTS for local development and production
# V .env nastavite: ALLOWED_HOSTS='localhost,127.0.0.1,.railway.app'
